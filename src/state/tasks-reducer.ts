...
import {setAppErrorAC, SetApErrorACType, setAppStatusAC, SetAppStatusACType} from "../app/app-reducer";
...
type ThunkDispatchType = Dispatch<ActionsTypes | SetAppStatusACType | SetApErrorACType>
